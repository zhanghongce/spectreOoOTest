...
# g++ test-spec-store-reorder-load2-mod.s -o test-spec-store-reorder-load2-mod
# 
	.file	"test-spec-store-reorder-load2.c"
	.globl	table0
	.bss
	.align 8
	.type	table0, @object
...
.LFB4:
	...
	movq	%rax, %rcx
#APP
# 59 "test-spec-store-reorder-load2.c" 1
	 mfence 			
 lfence			
 rdtsc				
 lfence			
...
.LC2:
	...
	.align 8
.LC3:
	.string	"store-load at least touched, but tb0 not touched:%ld\n"
.LC4:
