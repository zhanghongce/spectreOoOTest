# This mod is different from its original one as
# genereted by g++ test-spec-store-usable -S -O0
# compiled as : g++ test-spec-store-usable-mod.s -o test-spec-store-usable-mod
...
# store [r1], r2
# load  r3, [r4]  
# while r3 and r4 happen to compute the same value

	.file	"test-spec-store-usable.c"
	.globl	table_sep
	.bss
	.align 8
...
.L39:
	...
	# salq	$2, %rax
	# addq	%rcx, %rax
	movl	(%rdx), %edx  # eax, it used eax originally
	movl	%edx, -148(%rbp) # eax, -148(%rbp), 
	# HZ Edit END
	movq	tableCheck(%rip), %rax
	movl	-148(%rbp), %edx
	movslq	%edx, %rdx
