...
int main()
{
	...
	table1 = malloc(sizeof(unsigned char *)*64);
	table5 = malloc(sizeof(unsigned char *)*64);
	table6 = malloc(sizeof(unsigned char *)*64);
	...
	for(idx = 0; idx < 1000; idx ++)
	{
		...
		if( x>= 100 && t2 > 200 && tb5_2 < 100  )
			printf("T1 before this rnd: %ld,T1 after rnd: %ld,T5 before: %ld, T5 before rnd: %ld, T5 after rnd:%ld\n",t1,t2,tb5_1,t0,tb5_2);
